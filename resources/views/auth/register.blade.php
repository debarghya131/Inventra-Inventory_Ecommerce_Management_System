    ...
    <form method="POST" action="{{ route('register') }}" class="my-4">
        @csrf
            ...
            <div class="text-center text-muted mb-4">
                <p class="mb-0">Want to login ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sign in</a></p>
            </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Quick, Effective, and Productive With Invertra Admin Dashboard</h3>
